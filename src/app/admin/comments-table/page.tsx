...
const AdminCommentsTable = async () => {
    ...
    // getAllComments this component is server component not client component,
    // so, we must send token in header to fetch data. 
    // but in client component mustn't send cookie in header to server, 
    // because the request already has a cookie is stored by default.
    return (
